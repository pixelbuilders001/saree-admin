...
async function checkConstraints() {
    ...
    console.log("Result 1 Error:", JSON.stringify(res1.error));
    console.log("Result 1 Data:", JSON.stringify(res1.data));
    ...
    console.log("Result 2 Error:", JSON.stringify(res2.error));
    console.log("Result 2 Data:", JSON.stringify(res2.data));
}
